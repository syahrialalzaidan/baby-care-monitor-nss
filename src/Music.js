	...
	return (
		<div className="bg-[#FCFFE0] min-h-screen">
			...
			<div className="py-4 px-8 flex flex-col items-center justify-center">
				...
				<div className="bg-[#E4FFE0] mt-4 w-fit p-4 md:p-8 flex justify-center items-start gap-2 md:w-3/4">
					...
					<IoMdClose className="text-6xl cursor-pointer" onClick={handleStatus} />
				</div>
			</div>
		</div>
	);
